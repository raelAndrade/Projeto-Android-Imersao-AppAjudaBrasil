...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // list.add(Proposicao(1, "", "PEC", 2019, "Primeira Ementa de teste do projeto"))
        //  list.add(Proposicao(2, "", "PL", 2019, "Segunda Ementa de teste do projeto"))
    ...
    private fun load(){
        val request = JsonObjectRequest(
                ...
                Response.Listener<JSONObject>{
                    ...
                    adapter.notifyDataSetChanged() // Avisa o adapter que tem dados novos
                },
                null
        )

        requestQueue.add(request) // Adiciona essa chamada na file
    }
}